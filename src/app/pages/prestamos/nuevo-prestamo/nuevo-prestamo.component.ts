...
export class NuevoPrestamoComponent implements OnInit {
  ...
  inputMatricula = new FormControl({value:'Ejemplo matricula', disabled:true})
  ...
  constructor(config: NgbModalConfig, private modalService: NgbModal, public dialog: MatDialog) { 
